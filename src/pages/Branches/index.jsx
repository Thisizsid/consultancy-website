          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {branches.map((branch) => (
                ...
                >
                  {/* Header */}
                  <Link to={`/branches/${branch.id}`} className="flex items-start gap-3">
                    ...
                    <div>
                      <h2 className="font-bold text-text-primary text-base leading-snug group-hover:text-secondary transition-colors">
                        {branch.name}
                      </h2>
                  ...
                  <div className="mt-auto flex flex-col gap-2">
                    ...
                    >
                      ...
                      {photosFor(branch).length > 0 ? 'View Details & Photos' : 'View Branch Details'}
                    </Link>
                    {mapLinkFor(branch) && (
                      <a
